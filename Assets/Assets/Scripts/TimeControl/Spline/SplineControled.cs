...
public class SplineFollowerControlled : MonoBehaviour
{
    ...
    [Header("Options")]
    public bool playOnStart = true; // Option pour démarrer le mouvement automatiquement
    ...
    const float END_OFFSET = 0.0001f;
